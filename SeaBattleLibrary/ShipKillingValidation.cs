    ...
    public class ShipKillingValidation
    {
        public static void ShipKilling(int Index, int Letter)
        {
            if (Index == 0)
            {
                ...
                {
                    if (BattleShip.BotField[Index + 1, Letter] == 0 || BattleShip.BotField[Index + 1, Letter] == 3)
                    {
                        if (Letter == 0)
                        {
                            BattleShip.BotField[Index + 1, Letter + 1] = 3;
                            BattleShip.BotField[Index + 1, Letter] = 3;
                            BattleShip.BotField[Index, Letter + 1] = 3;
                    ...
                    else if (BattleShip.BotField[Index + 1, Letter] == 2)
                    {
                        ...
                        if (BattleShip.BotField[Index + cell + 1, Letter] != 1)
                        {
                            if (Letter == 0)
                            {
                                BattleShip.BotField[Index + cell, Letter] = 3;
                                BattleShip.BattleField[Index + cell, Letter] = 3;
                                for (; cell >= Index; cell--)
                                {
                                    BattleShip.BotField[Index + cell, Letter + 1] = 3;
            ...
            else
            {
                ...
                {
                    if ((BattleShip.BotField[Index + 1, Letter] == 0 || BattleShip.BotField[Index + 1, Letter] == 3)
                       && (BattleShip.BotField[Index - 1, Letter] == 0 || BattleShip.BotField[Index - 1, Letter] == 3))
                    {
                        if (Letter == 0)
                        {
                            BattleShip.BotField[Index - 1, Letter] = 3;
                    ...
                    else if (BattleShip.BotField[Index - 1, Letter] == 2 || BattleShip.BotField[Index + 1, Letter] == 2)
                    {
                        ...
                        if (ShipDead == true)
                        {
                            if (Index + CellUp <= 9)
                            {
                                BattleShip.BotField[Index + CellUp, Letter] = 3;
                                BattleShip.BattleField[Index + CellUp, Letter] = 3;
                            }
                            if (Index - CellDown >= 0)
                            {
                                BattleShip.BotField[Index - CellDown, Letter] = 3;
                            ...
                            if (Letter - 1 >= 0)
                            {
                                ...
                                {
                                    BattleShip.BotField[Index + i, Letter - 1] = 3;
                                ...
                                if (Index + CellUp <= 9)
                                {
                                    BattleShip.BotField[Index + CellUp, Letter - 1] = 3;
                                    BattleShip.BattleField[Index + CellUp, Letter - 1] = 3;
                                }
                                if (Index - CellDown >= 0)
                                {
                                    BattleShip.BotField[Index - CellDown, Letter - 1] = 3;
